...
\usepackage{tikz}
\usetikzlibrary{shapes.symbols,matrix,positioning,automata,fit,arrows.meta,calc,quotes}
...
\draw[arrow,color=blue] (ComA) -- (CommResA) -- (ComB);

\draw[arrow,color=blue] (StorResA) -- (ComB);


\draw[arrow,color=red, densely dashed]
(StorResC) -- (OtherA) -- (StorResB) --
(ComC) --  (CommResC) -- ++(-0cm,-2.8cm) node[midway,text width=1.8cm, xshift=-1cm,align=right, yshift=-.2cm,font=\scriptsize\sffamily]{exfiltration detected};
;
